              ...
              function(data) {
                return (
                  ...
                  >
                    ...
                    <td
                      className={
                        Number(data.price_change_percentage_1h_in_currency) > 0
                          ? "py-4 text-green"
                          : "py-4 text-red"
                      }
                    >
                    ...
                    <td
                      className={
                        Number(data.price_change_percentage_24h_in_currency) > 0
                          ? "py-4 text-green"
                          : "py-4 text-red"
                      }
                    >
                    ...
                    <td
                      className={
                        Number(data.price_change_percentage_7d_in_currency) > 0
                          ? "py-4 text-green"
                          : "py-4 text-red"
                      }
                    >
